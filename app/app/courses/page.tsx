          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Подберите полноценные программы с модулями, учебным планом и контрольными точками
              </p>
              <p className="mt-2 rounded-2xl border border-primary/20 bg-primary/5 px-3 py-2 text-xs text-muted-foreground">
                Внутри каждого курса: поэтапный силлабус, раскрываемые модули, задания с автопроверкой и итоговый
                трек к результату.
              </p>
            </div>
              ...
              <Dialog.Portal>
                ...
                <Dialog.Content className="fixed left-1/2 top-1/2 z-[71] w-[calc(100%-2rem)] max-w-xl -translate-x-1/2 -translate-y-1/2 rounded-3xl border border-border bg-white p-6 shadow-soft">
                  ...
                  <ol className="mt-3 space-y-2 text-sm text-muted-foreground">
                    <li>1. Выбираете программу и проходите входной модуль.</li>
                    <li>2. Открываете модули по шагам: теория → практика → тест → чекпоинт.</li>
                    <li>3. Выполняете задания с автопроверкой и заданиями ИИ + преподаватель.</li>
                    <li>4. Для сложных тем бронируете живой урок по расписанию.</li>
                    <li>5. Закрываете дорожную карту и выходите на сертификат курса.</li>
                  </ol>
